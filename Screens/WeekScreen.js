...
import { StyleSheet, View, SafeAreaView, Modal , Text, TouchableHighlight, Dimensions, ScrollView, Image} from 'react-native';
      ...
      <View style={styles.chartContainer}>
          <BarChart
            data={{
              ...
              datasets: [{ data: formatChartData(weekData) }]
            }}
            withDots={false}
        ...
        <View style={styles.totalDurationContainer}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.totalDurationValue}>{calculateTotalDuration(weekData)}</Text>
          </View>
        </View>
